// Детальная страница товара: фото, информация, вкладки "Описание"/"Отзывы", покупка.
// Использует фичи product-review и product-buy (кнопка "Купить").
...
import { ReviewList } from '@/features/product-review';
