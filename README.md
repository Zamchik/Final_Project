...
**KeyMarket** — это полнофункциональный маркетплейс для продажи и покупки цифровых товаров (игровых ключей, дополнений, подписок) с внутренним балансом, комиссией платформы и мгновенной автоматической выдачей ключей после оплаты.

### Проект выполнен в рамках дипломной работы и был показан на защите 11.07.2026. Защита прошла но я буду дальше работать над проектом. Следующие планируемы фичи находятся в самом внизу.
---
...
- **Обрезка изображений** — все фото автоматически приводятся к 4:3 через `react-easy-crop`, гарантируя одинаковый вид карточек.
...
Всего 85 тестов проходят (50 backend + 35 frontend)
...
graph TD
    ...
    Services --> External3["🖼️ Загрузка изображений (react-easy-crop + статика)"]
...
### 🛠️ Планируемые нововведения

Регистрация для реальных почтах
...
Расширение административной панели (логи, аналитика, диаграммы)

Добавление чата между покупателем и продавцом

Фиксы и доработка UI/UX
